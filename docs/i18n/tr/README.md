...
<img src="./docs/diagrams/free-tier-budget.svg" width="100%" alt="OmniRoute ücretsiz katman bütçe kartı: Tek bir uç nokta arkasında 34 yinelenen havuz anahtarına göre gruplandırılmış 443 kataloglanmış ücretsiz katman girdisinden, sabit olarak ayda ~1.47B ücretsiz token, kayıt kredileriyle ilk ay ~2.07B'a kadar. Dürüst havuz tekilleştirme matematiği — her paylaşımlı havuz bir kez sayılır; 13 sağlayıcı Hizmet Şartları bayraklıdır, böylece kararı siz verirsiniz. Sayılabilir ücretsiz havuzların model bazında ızgara bütçe çubuğu (Mistral 1B, Nara 210M, LLM7 150M, Groq 30M için model başına beş sınır ve daha küçük havuzlar), tek seferlik ilk ay kayıt kredileri (vertex 300M, agentrouter 200M, predibase 25M, glm-cn 20M, doubao 15M, ai21 10M, longcat 10M, deepseek 5M, hyperbolic 5M, nscale 5M), ayrıca kalıcı olarak ücretsiz token sınırı olmayan sağlayıcılar (SiliconFlow, Z.AI GLM-Flash, Gemini, Ollama Cloud, Kilo, OpenCode Zen, baidu …) ve +24M/ay kilidini açan 10 dolarlık OpenRouter yüklemesi ayrı gösterilir. ModelScope'un bölgesel kimlik doğrulamasına bağlı 6M kotası da ayrıca gösterilir ve başlığa eklenmez. /dashboard/free-tiers üzerinde canlı kullanılan/kalan."/>
