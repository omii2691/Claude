...
export const AGY_PUBLIC_MODELS = Object.freeze([
  // Gemini 3.8 Flash tiers. Per-effort upstream ids (`--effort low|medium|high` on the
  // CLI); they are dispatched verbatim, unlike the 3.7 tiers below which share one
  // `-tiered` upstream id.
  {
